...
Environment* Environment::createGlobalEnv() {
    ...
    env->declareVar(TokenType::Bool, "True", new BoolVal(true), 1);
    env->declareVar(TokenType::Bool, "False", new BoolVal(false), 1);
    env->declareVar(TokenType::Void, "None", new NoneVal(), 1);
    ////////////////////////////////

    env->declareVar(TokenType::Func, "print", new NativeFuncVal(printNativeFunc), 1);

    env->declareVar(TokenType::Func, "sqrt", new NativeFuncVal(sqrtNativeFunc), 1);
    env->declareVar(TokenType::Func, "cbrt", new NativeFuncVal(cbrtNativeFunc), 1);

    env->declareVar(TokenType::Func, "max", new NativeFuncVal(maxNativeFunc), 1);
    env->declareVar(TokenType::Func, "min", new NativeFuncVal(minNativeFunc), 1);

    env->declareVar(TokenType::Func, "sleep", new NativeFuncVal(sleepNativeFunc), 1);
    env->declareVar(TokenType::Func, "timerStart", new NativeFuncVal(timerStartNativeFunc), 1);
    env->declareVar(TokenType::Func, "timerStop", new NativeFuncVal(timerStopNativeFunc), 1);
    env->declareVar(TokenType::Func, "timerDuration", new NativeFuncVal(durationNativeFunc), 1);
